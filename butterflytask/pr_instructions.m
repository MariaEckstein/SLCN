...
if strcmp(phase, 'learn') % learning mode instructions
    ...
    preparestring('In this game you need to guess which flower each butterfly picks to feed from.', ...
    ...
    clearkeys;
    clearpict(exp.buffer.instructions);
    preparestring('Here is a hint: Each butterfly has a favourite flower,', ...

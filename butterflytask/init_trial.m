...
elseif strcmp(pic_no_pic, 'no_picture')
    loadpict('stims/cor.jpg', exp.buffer.correct, exp.p.feedback_x, exp.p.feedback_y - 100);
    loadpict('stims/inc.jpg', exp.buffer.incorrect, exp.p.feedback_x, exp.p.feedback_y - 100);
end

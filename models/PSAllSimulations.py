    ...
    for trial in range(n_trials):
        ...
        if 'RL' in model_name or 'WSLS' in model_name:
            ...
            if trial == 0:
                ...
                if not calculate_NLL_from_data:  # TODO: Why?
...
data_dir = 'C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/mice/'
...
for file_name in file_names:
    ...
    if simulate_agents:
        simulated_nll = simulate_model_from_parameters(parameters, data_dir, n_subj, n_trials=200, calculate_NLL_from_data=False, loaded_data=None, make_plots=False, verbose=verbose, n_sim_per_subj=n_sim_per_subj)

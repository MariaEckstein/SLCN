    ...
    with pm.Model() as model:
        if True:
            ...
            if 'RL' in model_name:
                ...
                if 'd' in model_name:
                    bias = create_parameter('bias', 'Beta', 'f' in model_name, n_groups, group, n_subj, upper, slope_variable, contrast)
                else:
...
for model_name in model_names:
    ...
    for slope_variable in slope_variables:
        ...
        model, n_params, n_trials, save_dir, save_id = create_model(
            ...
            model_name=model_name, slope_variable=slope_variable, contrast=contrast, fit_mcmc=fit_mcmc,

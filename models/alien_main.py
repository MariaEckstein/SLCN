...
parameters['fit_pars'] = np.array([par in fit_par_names for par in parameters['par_names']])
fit_par_col_name = '_'.join([agent_stuff['learning_style'], '_'.join(fit_par_names)])

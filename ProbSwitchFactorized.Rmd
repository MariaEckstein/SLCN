...
if (data_name == "PCsim") {
  ...
  # Get simulated data
  patterns = paste0(c("PC_mean_", "PC1plus_", "PC1minus_", "PC2plus_", "PC2minus_", "PC3plus_", "PC3minus_", "PC4plus_", "PC4minus_", "PC5plus_", "PC5minus_"), model_class)
...
write.csv(ACCs, "C:/Users/maria/MEGAsync/SLCNdata/Meta/ps_behav.csv")
```
...
c_age_logregr_validation =
  c_age_ACC_validation + aes(y=z_sig_Estimate) +
...
# Save plots
ggsave(file.path(plot_dir, paste0(model_class, "b_age_stayappswitch.eps")), b_age_stayappswitch, width=6, height=3)
...
ggsave(file.path(plot_dir, paste0(model_class, "c_age_logregr_validation.png")), c_age_logregr_validation, width=7.5, height=9)
...
# Save plot
ggsave(file.path(plot_dir, "f_age_param.eps"), f_age_param, width=8, height=8)
```
...
ggsave(file.path(plot_dir, "g_agegroup_PCs.eps"), g_agegroup_PCs, width=5, height=5)

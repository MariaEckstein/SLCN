...
plot_switch_counts = function(all_files, gg_save) {
  ...
  gg_switch_counts = ggplot(switch_counts, aes(PreciseYrs, n_switches)) + geom_point()
  
  if (gg_save) {
    ggsave(file.path(plot_dir, "/gg_switch_counts.png"), gg_switch_counts)
  }
}
```
...
#   plot_switch_counts(all_files, gg_save)
...
if (data_name == "simulated_human") {
  ...
  dir_to_all_simulations = 'C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/map_indiv/simulate_without_replace_rewards/simulations'

...
plot_performance_over_age = function(ACCs, gg_save) {
  ...
  if (gg_save) {
    ...
    ggsave(file.path(plot_dir, "/gg_stay_age.png"), gg_stay_age)
...
run_regression = function(all_files_regr) {
  ...
  # sel_rew_mod = glmer(selected_box ~ back1selected + back1reward + (back1selected + back1reward | sID),
  #           family = "binomial",
  #           data = all_files_regr,
  #           verbose = T)
...
plot_regression = function(nback_regr_dat, gg_save) {
  ...
  if (gg_save) {
    ...
    ggsave(file.path(plot_dir, "rewnorew_regr_age.png"), rewnorew_regr, width=5, height=3 + length(unique(gg_ACC_blocks$data$model_name)))
...
dir_to_all_simulations = 'C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/map_indiv/new_ML_models/simulate/simulations'
...
if (data_name == "simulated_human") {
  ...
  for (data_dir in data_dirs) {  # [8:length(data_dirs)]
    # data_dir = "C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/map_indiv/new_mcmc_models_cluster/simulate/simulations/RLabcpnlyoqt_age_z_213"
...
summary(lmer(same_choice_01_back ~ PreciseYrs + PreciseYrs2 + (1 | sID), subset(all_files, outcome_21_back=='reward, no reward' & Gender == "Female")))
summary(lmer(same_choice_01_back ~ PreciseYrs + PreciseYrs2 + (1 | sID), subset(all_files, outcome_21_back=='reward, no reward' & Gender == "Male")))

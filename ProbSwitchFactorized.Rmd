...
correlate_params_behavior = function(all_files, human_data_dir, model_name, gg_save) {
  ...
  if (grepl("B", model_name)) {
    ...
    params = ddply(all_files, .(sID),
                   PreciseYrs=PreciseYrs[1], PDS=PDS[1], BMI=BMI[1], T1=T1[1],
                   beta=beta[1], persev=persev[1], alpha=alpha[1], nalpha=nalpha[1], calpha=calpha[1], cnalpha=cnalpha[1], summarize)  # calpha_sc=calpha_sc[1], cnalpha_sc=cnalpha_sc[1],
...
dir_to_all_simulations = 'C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/map_indiv/new_mcmc_models_cluster/ready_params/simulations'
```
```{r do_it_all}
# do_it_all = function() {
#   
...
if (data_name == "simulated_human") {
  ...
  for (data_dir in data_dirs) {
    data_dir = "C:/Users/maria/MEGAsync/SLCN/PShumanData/fitting/map_indiv/new_mcmc_models_cluster/ready_params/simulations/RLabcpn_nsubj179_age_z/"

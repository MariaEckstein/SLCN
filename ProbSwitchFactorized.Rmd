...
data_name = "PCsim"  # can be "PCsim" (only look at PC-based simulations) or "HumAndSim" (look at human data and BF-&RL-simulated data)
exclude_UCB = F
...
if (data_name == "PCsim") {
  ...
  # Get simulated data
  for (patt in c("PC1plus", "PC1minus", "PC2plus", "PC2minus", "PC3plus", "PC3minus", "PC4plus", "PC4minus", "PC5plus", "PC5minus")) {
...
# Save plots
ggsave(file.path(plot_dir, "a_trialsinceswitch_ACC.png"), a_trialsinceswitch_ACC, width=5 + l, height=2)
ggsave(file.path(plot_dir, "a_outcome12back_stay.png"), a_outcome12back_stay, width=3 + l, height=2)

...
for (subj in unique(all_files_regr$sID)) {
  for (n in 1:12) {
    ...
    ## Add nback columns
    for (cond in c(reward_predictors, sel_rew_predictors)) {  # choice_predictors, 
    ...
    nback_regr_dat = rbind(nback_regr_dat, reward_coefss, sel_rew_coefss)  # , choice_coefss
  }
}
# Beautify
...
gg_nback_regr_agecats_sig = gg_nback_regr_agecatss + aes(y = sig_Estimate)

# Save plots
ggsave(file.path(plot_dir, "gg_nback_regr_agecats.png"), gg_nback_regr_agecats)
ggsave(file.path(plot_dir, "gg_nback_regr_agecont.png"), gg_nback_regr_agecont)
ggsave(file.path(plot_dir, "gg_nback_regr_agecats_sig.png"), gg_nback_regr_agecats_sig)
ggsave(file.path(plot_dir, "gg_nback_regr_agecont_sig.png"), gg_nback_regr_agecont_sig)
```

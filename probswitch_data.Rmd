...
```{r Set up parameters}
data = "RL/softmax_vary_perseverance"  # can be "RL", "Bayes", or "human"
...
if (data != "human") {
  ...
  gg_example_values = ggplot(all_files) +
    geom_line(aes(TrialID, values_l), color="red") +
    geom_line(aes(TrialID, values_r), color="blue") +
    # geom_vline(xintercept = which(all_files$switch_trial)) +
  ...
  gg_example_probs = ggplot(all_files) +

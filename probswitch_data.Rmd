...
# ACC over blocks
B = ggplot(subset(all_files, !is.na(choice_left)), aes(trialsinceswitch, 100 * better_box_left, color = choice_left, group = choice_left)) +
  stat_summary(fun.data = mean_cl_normal, fun.args = list(mult = 1), geom = "pointrange") +
...
C = ggplot(subset(all_files_sum, !is.na(choice_12_back)),

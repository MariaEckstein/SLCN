...
# starting each trial 
    def init_trial(self):
        if self.RunningTotal == self.revafter and self.reversal == 0:
            self.reversal = 1
            self.RunningTotal = 0
            # this is my code to start counting number of trials for Rev phase from 0
        ...
        self.dragtime = 0
        self.trial_no += 1
        # this is my code to keep count of number of trials in each phase 

...
if (gg_save) {
  if (data %in% c("human", "fitted_human")) {
    ggsave(file.path(plot_dir, "/gg_PDS_composition.png"), gg_PDS_composition)
    ggsave(file.path(plot_dir, "/gg_age_composition.png"), gg_age_composition)
    ggsave(file.path(plot_dir, "/gg_T_composition.png"), gg_T_composition)
  }
}
```

...
desired_columns = c("sID", "selected_box", "p_right", "reward", "RT", "correct", "correct_box", "learning_style", "model_name", "NLL", parameter_names, paste0(parameter_names, "_rec"))
...
if (data %in% c("human", "fitted_human")) {
  ...
  ages = read.csv("C:/Users/maria/MEGAsync/SLCNdata/ages.csv")
  colnames(ages) = c("sID", "PreciseYrs")
  ages$age_group = "Adults"
  ages$age_group[ages$PreciseYrs < 18] = "Teens"
  ages$age_group[ages$PreciseYrs < 13] = "Children"
  ages$age_group = factor(ages$age_group, levels = c("Children", "Teens", "Adults"))
